# Generated by Django 5.2.1 on 2025-09-02 11:26
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especializacao', models.CharField(blank=True, choices=[('CLINICA_GERAL', 'Clínica Geral'), ('CARDIOLOGIA', 'Cardiologia'), ('ORTOPEDIA', 'Ortopedia'), ('PEDIATRIA', 'Pediatria'), ('NEUROLOGIA', 'Neurologia'), ('OUTRA', 'Outra')], max_length=50, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hora_chegada', models.DateTimeField(blank=True, default=django.utils.timezone.now)),
                ('hora_inicio_atendimento', models.DateTimeField(blank=True, null=True)),
                ...
                ('medico_responsavel', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pacientes_atendidos', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
