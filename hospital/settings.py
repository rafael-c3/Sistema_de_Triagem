...
SECRET_KEY = 'django-insecure-pd_%p_59avl0f!60qrwoqf2#f*(7*3t0*v+zb#%(6xl5093p=!'
...
AUTH_PASSWORD_VALIDATORS = [
    ...
    {
        'NAME': 'triagem.validators.RequiresUppercaseValidator',
    },
    {
        'NAME': 'triagem.validators.RequiresNumberValidator',
    },
]
